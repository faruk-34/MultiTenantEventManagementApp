...
namespace Application.Interfaces
{
    public interface IEventService
    {
        ...
        // Task<List<EventVM>> GetAllFilter(EventFilterVM filter, CancellationToken cancellationToken);
        IQueryable<Event> GetAllFilter(EventFilterVM filter, CancellationToken cancellationToken);
